...
import { XIcon } from "lucide-react" import { cn } from "@/lib/utils" function Dialog({ ...props
...
DialogOverlay.displayName = DialogPrimitive.Overlay.displayName function DialogContent({ className, children, showCloseButton = true, ...props
